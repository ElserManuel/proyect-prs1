pipeline {
    ...
    environment {
        ...
        // Variables de SonarQube para el microservicio Family
        SONAR_PROJECT_KEY = 'ElserManuel_proyect-prs1-family'
    ...
    post {
        ...
        success {
            ...
            echo "🎉 Microservicio Family construido exitosamente"
            echo "📦 Artefacto disponible en Jenkins"
            echo "📊 Análisis de calidad disponible en SonarCloud"
        }
        failure {
            echo 'Pipeline fallido.'
            echo "❌ Error en el build del microservicio Family"
        }
        unstable {
            echo 'Pipeline inestable - algunas pruebas fallaron.'
            echo "⚠️ Microservicio Family construido con advertencias"
        }
    }
}
